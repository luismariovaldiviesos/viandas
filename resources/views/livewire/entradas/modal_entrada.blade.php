<div wire:ignore.self id="modalEntrada" class="modal" data-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                            ...
                            <div class="preview">
                                <div class="overflow-x-auto">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="searchEntrada" id="usuario-search" type="text" class="form-control form-control-lg kioskboard" placeholder="Buscar Entrada" >
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="dark:bg-dark-1 text-lg {{$loop->index % 2 > 0 ? 'bg-gray-200' : ''}}">
                                                ...
                                                <td>
                                                    ...
                                                    <button wire:click="searchManualEntrada({{ $entrada->id }})" class="btn btn-outline-primary">Seleccionar</button>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
            ...
            <div class="modal-footer text-right">
                <button onclick="closeModalEntrada()" class="btn btn-outline-secondary mr-5">Cerrar Ventana</button>
            </div>
