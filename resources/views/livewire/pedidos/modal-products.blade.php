                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="dark:bg-dark-1 text-lg {{$loop->index % 2 > 0 ? 'bg-gray-200' : ''}}">
                                                ...
                                                {{-- <td class="border-b dark:border-dark-5 ">
                                                    {{ number_format($menu->price2, 2) }}
                                                </td> --}}
                                                <td>
                                                    <button wire:click="searchManualProduct({{ $menu->id }})" class="btn btn-outline-primary">Seleccionar</button>
                                                </td>

                                            </tr>
                                            @empty
                                            <tr>
                                                <td colspan="5" class="text-center">NO HAY MENUS REGISTRADOS</td>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
