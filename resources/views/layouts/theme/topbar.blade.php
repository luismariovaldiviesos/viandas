<div class="top-bar">
    <!-- BEGIN: Breadcrumb -->
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="https://www.khipu.com">by</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Khipu Desarrolo de Software</a> </div>
    <!-- END: Breadcrumb -->
        ...
        <div class="dropdown-menu w-56">
            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                <div class="p-4 border-b border-theme-27 dark:border-dark-3">
                    ...
                    <div class="text-xs text-theme-28 mt-0.5 dark:text-gray-600">Admin</div>
                </div>
                <div class="p-2">
