                            ...
                            <div class="preview">
                                <div class="overflow-x-auto">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="search" id="user-search" type="text" class="form-control form-control-lg kioskboard" placeholder="Buscar" >
                                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="dark:bg-dark-1 text-lg {{$loop->index % 2 > 0 ? 'bg-gray-200' : ''}}">
                                                ...
                                                <td>
                                                    <button wire:click.prevent="$set('userId', '{{ $user->name . ' | ' . $user->id  }}')"
                                                    class="btn btn-outline-primary">Seleccionar</button>
                                                </td>
                                            </tr>
                                            @empty
                                            <tr>
